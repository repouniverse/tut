...
?>
<h4><i class="fab fa-firstdraft"></i><?='   '.Yii::t('message', 'Create a draft')?></h4>
...
<div class="draft-create">
    ...
    <div class="draft-form">
        ...
        <?= Html::submitButton(
                '<i class="fa fa-floppy-o"></i> ' . Yii::t('message', 'Save'),
            ['name' => 'save-draft', 'class' => 'btn btn-success']) ?>

        <?= Html::submitButton(
                '<i class="fa fa-envelope-o"></i> ' . Yii::t('message', 'Send'), [
            'name' => 'send-draft',
