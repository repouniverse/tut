...
if(!$this->existsTable($table)) {
    $this->createTable($table,  [
        ...
        'fecha'=>$this->char(10)->append($this->collateColumn()),
         ...
         'unidad_id'=>$this->integer(11)->comment('Unidad PARA AGRUPAR LA COBRANZA DE LA INMOILIARIA , NO SE APLICA EN MUCHOS EDIFICIOS, SOLO EN EDIFICOIS MIXTOS EN PROESO DE VENTAS DE DEPAS para agrupar un solo reporte de cobranza'),
