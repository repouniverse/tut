  ...
  public function safeUp()
    {
        ...
        $comando->createView($vista,
                (new \yii\db\Query())
    ->select([
         'a.id','a.numerorecibo','a.consumototal','a.montototal','a.participacion','a.codsuministro','a.aacc','a.delta','a.lectura','a.cuentaspor_id','a.edificio_id','a.unidad_id','a.colector_id','a.grupo_id','a.monto','a.igv','a.grupounidad','a.grupofacturacion','a.facturacion_id','a.mes','a.anio','a.identidad','a.numerorecibo','a.unidades',//detalle facturacion  a
