...
?>
 ...
 <div class="box-body">
    ...
    <?php $form = ActiveForm::begin(['id'=>'form-convojgjgcatoria',
     ...
     <h4>INFORME DEL PERFIL PSICOLÓGICO (IPP)</h4>
   ...
   <?php 
    ...
    'items' => [
        ...
        [
            ...
            'content' => $this->render('_modal_docu_alu_105_indicadores_encontrados_entrevista',['model'=>$model,'form'=>$form]),
            // open its content by default
            'contentOptions' => ['class' => 'in']
        ],
        
        [
            'label' => 'III Conclusiones de la evaluación',
            'content' => $this->render('_modal_docu_alu_105_conclusiones',['model'=>$model,'form'=>$form]),
            'contentOptions' => ['class' => 'in'],
            'options' => [],
        ],
        // if you want to swap out .panel-body with .list-group, you may use the following
        [
            'label' => 'IV Metas de tutoría',
          'content' => $this->render('_modal_docu_alu_105_metas',['model'=>$model,'form'=>$form]),
        ...
        [
            'label' => 'V Recomendaciones para el tutor académico',
          'content' => $this->render('_modal_docu_alu_105_recomendaciones',['model'=>$model,'form'=>$form]),
