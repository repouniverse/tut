...
$this->title = Yii::t('base.names', 'Update Help Ayuda: {name}', [
    'name' => $model->id,
]);
...
<h4><i class="fa fa-edit"></i><?= Html::encode($this->title) ?></h4>
    ...
    'items' => [
        ...
        [
          'label'=>'<i class="fa fa-users"></i> '.yii::t('sta.labels','Log'), //$this->context->countDetail() obtiene el contador del detalle
